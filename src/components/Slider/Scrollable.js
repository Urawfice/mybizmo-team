      ...
      {items.length > 0 ? (
        <div className="row noMargin noPadding ">
          <div className="row noMargin noPadding top_head_sec">
            ...
            <div
              className="col-6 text-right noMargin noPadding  "
              style={{ display: "grid" }}
            >
                  ...
                  item.image_one !== undefined ? (
                    <Link
                      ...
                      to={{
                        ...
                        checkS: {
                          activeBtn: displayTitle,
                          displayTitle: item.package_type.split(" ")[0],
                        },
                        id: item.id,
                      }}
                    >
                        ...
                        <div className="card_head ">
                          <div className="card_header_sec ">
                            ...
                            <img
                              onMouseOver={onHover}
                              onMouseOut={offHover}
                              className="card_absolute_first_img faI"
                              src={item.category_icon}
                              alt="icon"
                            />
                            <div className="hover_category_name">
                              <span className="cat_name_hover">
                                {" "}
                                {item.category_name}
                              </span>
                            </div>
                              ...
                              onClick={
                                item.is_bookmark
                                  ? (e) =>
                                      bookmark(
                                        e,
                                        "users/remove-bookmark-package",
                                        "delete"
                                      )
                                  : (e) =>
                                      bookmark(
                                        e,
                                        "users/add-bookmark-package",
                                        "post"
                                      )
                              }
                              alt="icon"
                    ...
                    <div className="col-xl-10 col-lg-10 col-md-11 col-sm-10 col-10 noPadding">
                      ...
                      <div className="row noMargin noPadding mail_sec">
                        ...
                        <div className="col-xl-10 offset-xl-2 col-lg-10 offset-lg-2 col-md-11 offset-md-1 col-sm-10 offset-sm-2 col-10 offset-2 noPadding text-left">
                          <div className="row noMargin noPadding mail_sec">
                            <div
                              className="col-xl-3 col-lg-2 col-md-3 col-sm-3 col-3 text-left noPadding"
                              style={{ display: "grid" }}
                            >
                            ...
                            <div className="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9 noPadding text-left">
                              <div class="input-group copy_link_grp">
                                <input
                                  type="text"
                                  className="form-control copy_link"
                                  value={currUrl}
                                ...
                                <div class="input-group-append">
                                  <span
                                    ...
                                    class="input-group-text copy_img_span"
                                    id="basic-addon2"
                                  >
                                    {!isCopy ? (
                                      <img
