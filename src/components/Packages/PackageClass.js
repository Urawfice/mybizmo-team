  ...
  return (
    <div className={classes.root}>
      ...
      {check === 1 ?
        ...
        : <div></div>}
      <main className="package_class_main">

        {/* Button section */}
        <div className="top_btn_sec row noMargin">
          <div className="col-8 noPadding noMargin text-left">
            <span className="head_package_span"> Packages</span>
            {isOnline === true ?
              <>
                <Link to={{ pathname: '/packages', checkS: { displayTitle: "Online" } }}><button onClick={onlineClick} className="active_btn common_btn margin_left_btn">Classes</button></Link>
                <Link to={{ pathname: '/packages', checkS: { displayTitle: "Offline" } }}><button onClick={offlineClick} className="not_active_btn common_btn margin_left_btn">Library</button></Link>
              </>
              :
              <></>}
            ...
            {isOffline === true ?
              <>
                <Link to={{ pathname: '/packages', checkS: { displayTitle: "Online" } }}><button onClick={onlineClick} className="common_btn not_active_btn margin_left_btn">Classes</button></Link>
                <Link to={{ pathname: '/packages', checkS: { displayTitle: "Offline" } }}><button onClick={offlineClick} className="common_btn active_btn margin_left_btn">Library</button></Link>
              </>
              :
              <></>}
            </div>
            <div className="col-4 noPadding noMargin text-right">
              <button onClick={filterClick} className="common_btn not_active_btn">
                <img className="filter_img" src="/Images/filter.svg" />
                Filters
              </button>
                    ...
                    <div className="row noMargin noPadding card_inside_row">
                      <div className="row noMargin noPadding header_btn_row">
                        ...
                        <div className="single_lib_top_bookmark_btn_sec col-xl-3 col-lg-3 col-md-3 col-sm-4 col-4 noPadding text-right">
                          ...
                          {item.is_bookmark ?
                            <img className="card_bookmark_icon" style={{ backgroundColor: "inherit"}} src={(HoverC && colId === item.id) ? "/Images/bookmarkW1.svg" : "/Images/bookmarkFB.svg"} id={item.id} onClick={removeBookmark} alt="icon" />
                            :
                            <img style={{ backgroundColor: "inherit"}} className="card_bookmark_icon" src={(HoverC && colId === item.id) ? "/Images/bookmarkW1.svg" : "/Images/bookmarkU1.svg"} id={item.id} onClick={setBookmark} alt="icon" />
                          }
                        </div>
                      </div>
                      <div className="row noMargin noPadding item_details_row">
                        ...
                        <div className="row noMargin noPadding classes_share_row" >
                          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 noMargin noPadding text-left" >
                            <span className="class_hrs_span"><b>{item.total_class}</b> classes | 2 hours</span>
                          </div>
                        ...
                        <div className="row noMargin noPadding" >
                          ...
                          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 noMargin noPadding text-right pos_relative" >
                            <div className="bottom_sec_right_div">
                              <span className="package_rate_span" >Package Rate</span>
                              <div className="item_price_div" >
                                <i class="fa fa-inr"></i> <b>{item.price}</b>
                              </div>
                            </div>
                      ...
                      {isFilterShow ?
                        <div className="overlay-filter shadow" >
                          ...
                          {isOnline ?
                            ...
                            :
                            <>
                              <div className="claType claType1">Content Type</div>
                              <div className="tp-con">
                                <button className="tp-option tp-all" style={{ width: "130px", background: "none", border: "none" }}>
                                  {onlineFArray.includes("All") ?
                                    <img src="/Images/checked.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("All")} />
                                ...
                                <button className="tp-option tp-on" style={{ width: "130px", background: "none", border: "none" }}>
                                  {onlineFArray.includes("Audio") ?
                                    <img src="/Images/checked.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Audio")} />
                                    :
                                    <img src="/Images/uncheck.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Audio")}  ></img>
                                  }
                                ...
                                <button className="tp-option tp-off" style={{ width: "130px", background: "none", border: "none" }}>
                                  {onlineFArray.includes("Video") ?
                                    <img src="/Images/checked.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Video")} />
                                    :
                                    <img src="/Images/uncheck.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Video")}  ></img>
                                  }
                                  Video</button>
                                <button className="tp-option tp-evn" style={{ width: "130px", background: "none", border: "none" }}>
                                  {onlineFArray.includes("Quote") ?
                                    <img src="/Images/checked.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Quote")} />
                                    :
                                    <img src="/Images/uncheck.svg" style={{ height: "24px", float: "left", marginTop: "8px", marginRight: "10px" }} onClick={() => onClassFilter("Quote")}  ></img>
                                  }
                                  Quotes</button>
                              </div>
                            </>
                          ...
                          <div className="catPc mb-4"  style={{paddingBottom:"8vh"}} >
                          ...
                          <div className='footer_btns'>
                            ...
                            <button className="btnClr2" onClick={() => clearAll()}> Clear All</button>
                          </div>
                        </div>
                        :
                        <></>
              ...
              {isFilterShow ?
                <>
                  <div className="overlay-filter shadow" >
                    ...
                    <div className="claType wellnessCat scCat">Featured</div>
                    <div className="catPc"  style={{paddingBottom:"8vh"}} >
