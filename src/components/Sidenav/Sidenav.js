      ...
      <main className="home_page_main_class">
              ...
              <>
                {item === "X" || item.banner_image === undefined ?
                  <div style={{ backgroundColor: "white", borderRadius: "10px", }} className="item outer" >
                    <img className="slider_img" alt="img" src="/Images/default-banner.png" />
                  </div>
                  :
                  <div style={{ backgroundColor: "white", borderRadius: "10px", position: "relative" }} className="slider_img_div" >
                    <img className="slider_img" alt="img" src={item.banner_image} />
                  </div>
                }
              </>
            ))}
        ...
        {onlinePack.length > 0 && offlinePack.length > 0 && eventPack.length > 0 ?
          <div className="row noMargin noPadding">
            <div className="section_head text-left">Your Schedule For Today</div>
            <div className="row noMargin noPadding">
              <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 noMargin schedule_card_div">
                <Card count={onlineCount} defImg={onlineDef} title="online" items={online} />
              </div>
              <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 noMargin schedule_card_div">
                <Card count={offlineCount} defImg={offlineDef} title="offline" items={offLine} />
              </div>
              <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 noMargin schedule_card_div">
                <EventCard count={eventCount} defImg={eventDef} title="events" items={events} />
              </div>
            </div>
          </div>
          : <div></div>
            ...
            {onlinePack.length > 0 ?
              <div className="row noMargin noPadding">
                <div class="online_scroll_div noPadding">
                  <Scrollable package="Online Class" title="online" url="/users/packages" items={onlinePack} />
                </div>
              </div>
              :
              <div></div>
            ...
            {offlinePack.length > 0 ?
              <div className="row noMargin noPadding">
                <div class="offline_scroll_div" >
                  <Scrollable package="Offline Class" title="offline" url="/users/packages" items={offlinePack} />
                </div>
              </div>
              : <div></div>
            }
            {eventPack.length > 0 ?
              <div className="row noMargin noPadding">
                <div class="event_scroll_div" >
                  <Scrollable package="Event" title="events" url="/users/packages" items={eventPack} />
                </div>
              </div>
              : <div></div>
            }
        ...
        {onlinePack.length === 0 && offlinePack.length === 0 && eventPack.length === 0 ?
          <div>
            {audio.data || video.data || quotes.data ?
              <div className="section_head text-left">Content Library Packages</div>
            :
              <></>
            }
          </div>
        ...
        <div className="row noMargin explore_main_div recommended_main_div">
          <div className="card explore_card noPadding">
            <div className="row noMargin noPadding">
              <div class="online_scroll_div noPadding">
                <Recommended title="Recommended For You" url="/users/recommendation-package-list" />
              </div>
            </div>
            <div className="row noMargin noPadding">
              <div class="online_scroll_div noPadding">
                <ExclusiveFreebies title="Exclusive Freebies" url="/users/recommendation-other-list" />
              </div>
            </div>
          </div>
        </div>
