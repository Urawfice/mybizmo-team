        ...
        <div className={classes.root}>
            ...
            <main className="my_forms_main mt-0 pt-0">
                ...
                <div className="row noMargin noPadding btn_row button_margin_top" >
                    <button onClick={() => onArticleClick()} className={activeBtn1 === 'Article' ? "common_btn blue_active" : "common_btn not_active_btn"} >Articles</button>
                    <button onClick={() => onNewsClick()} className={activeBtn1 === 'News' ? "common_btn blue_active margin_left_btn" : "common_btn not_active_btn margin_left_btn"}>News</button>
