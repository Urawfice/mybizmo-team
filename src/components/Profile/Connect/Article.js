...
import uplaod from "../../BizZone/BizImages/upload.png";
...
export default function Article(props) {
  ...
  const [activeBtn1, setActiveBtn1] = useState("Article");
  ...
  const openMsg = (e, index) => {
    ...
    axios
      .get("/masters/must-read-detail/" + idd, {
        headers: {
          Authorization: "Token" + " " + cookies.get("token"),
        },
      })
  ...
  const [createNewNews, setCreaateNewNews] = useState(false);

  const createArticleFn = () => {
    SetCreateNewArticle(true);
    setCreaateNewNews(false);
  };

  const createNewsFn = () => {
    SetCreateNewArticle(false);
    setCreaateNewNews(true);
  };
  ...
  console.log(title, description, imageUpload, articleBody, cookies.get("id"));

  function ArticleFormCreateFn() {
    let formData = new FormData();

    formData.append("title", title);
    formData.append("author ", cookies.get("id"));
  ...
  const [publicationLogo, setPublicationLogo] = useState("");

  function NewsFormCreate() {
    let formData = new FormData();

    formData.append("publisher", publication);
    formData.append("title ", newsTitle);
    formData.append("publisher_logo", publicationLogo);
    formData.append("publisher_logo_link", imageUpload);
    formData.append("content", newsDescription);
    formData.append("news_link", articleUrl);
    formData.append("publication_date", newsDate);
    formData.append("publication_datenews_pdf", newsPdf);
    ...
    <div className={classes.root}>
      ...
      <main className="my_forms_main mt-0 pt-0">
        <div className="row noMargin noPadding button_margin_top">
          <span className="page_head noPadding "> Article / News </span>
        </div>

        {createNewNews === false && createNewArticle === false ? (
          <>
            <div className="row noMargin noPadding btn_row button_margin_top">
              ...
              <button
                ...
                className={
                  activeBtn1 === "News"
                    ? "common_btn blue_active margin_left_btn"
              ...
              <div className="text-right">
                <button
                  onClick={createArticleFn}
                  className="common_btn active_btn mr-2"
                  style={{ position: "relative", top: "-30px", width: "12vw" }}
                >
                  Create new - Articles
                </button>
                <button
                  onClick={createNewsFn}
              ...
              <table className="table noPadding">
                <thead className="theading">
                  <tr>
                    ...
                    <th className="action_sec"> Actions </th>
                  </tr>
                </thead>
        ...
        {createNewArticle === true ? (
          <div className="row">
            <div className="col-xl-11 mx-auto  news-back">
              <p className="new-form-header  pl-5 pt-4">Create New Article</p>
              <div className="row">
                <div className="col-xl-5 mx-auto">
                  <div className="row">
                    <div className="col-xl-12 ">
                      <p className="mb-1 new-form-title">Title</p>
                      <input
                        type="text"
                    ...
                    <div className="col-xl-12 mt-4 mb-0">
                      <p className="mb-1 new-form-title">
                        Upload Article Image
                      </p>
                      <label className="custom-file-upload pl-3 pr-3 pt-1 pb-1">
                        <input
                          type="file"
                ...
                <div className="col-xl-5 mx-auto">
                  <p className="mb-1 new-form-title">Description</p>
                  <textarea
                    rows="4"
                    cols="50"
              ...
              <div className="row mt-5 mb-5">
                <div className="col-xl-11 mx-auto ">
                  <p className="mb-1 new-form-title">Body of the Article</p>
                  <textarea
                    rows="6"
                    cols="120"
                ...
                <div className="col-xl-11 mx-auto">
                  <div className="row">
                    <div className="col-xl-2 col-lg-2 col-md-4 col-4">
                      <button
                        class="common_btn blue_active"
                        onClick={ArticleFormCreateFn}
                      >
                        Save
                      </button>{" "}
                    </div>
        ...
        {createNewNews === true ? (
          <div className="row">
            <div className="col-xl-11  mx-auto news-back">
              <p className="new-form-header  pl-5 pt-4">Create New News</p>
              <div className="row mt-4">
                ...
                <div className="col-xl-5 mx-auto ">
                  <p className="mb-1 new-form-title">Publication</p>
                  <input
                    type="text"
                    onChange={(e) => setPublication(e.target.value)}
                    placeholder="Name of the publication that published the news..."
                    className="new-form-input"
                  ></input>
                </div>
              </div>
              ...
              <div className="row mt-4">
                <div className="col-xl-5 mx-auto ">
                  <div className="row">
                    <div className="col-xl-12 ">
                      <p className="mb-1 new-form-title">Date</p>
                      <input
                        type="date"
                    ...
                    <div className="col-xl-12  mt-4">
                      <p className="mb-1 new-form-title">Article URL</p>
                      <input
                        type="text"
              ...
              <div className="row mt-4">
                <div className="col-xl-5 mx-auto ">
                  <p className="mb-1 new-form-title">
                    or Upload PDF Document of the Article
                  </p>
                  <label className="custom-file-upload pl-3 pr-3 pt-1 pb-1">
                    <input
                      type="file"
                      onChange={(e) => setNewsPdf(e.target.files[0])}
                    />
                    Upload{" "}
                    <img
                      src={uplaod}
                ...
                <div className="col-xl-5 mx-auto ">
                  <p className="mb-1 new-form-title">Upload Publication Logo</p>
                  <label className="custom-file-upload pl-3 pr-3 pt-1 pb-1">
                    <input
                      type="file"
                      onChange={(e) => setPublicationLogo(e.target.files[0])}
                    />
                    Upload{" "}
                    <img
                      src={uplaod}
          ...
          <div ref={modalRef} className="overlay_msg shadow-lg">
            ...
            <div className="popup_body">
              <div className="center_body">
                ...
                {quesData[fmIndex].question_type === "TextField" ? (
                  <div>
                    <textarea
                      ...
                      className="text_area"
                      rows={
                        windowWidth < 768 && windowWidth > 575
                          ? "5"
                          : windowWidth < 576
                          ? "3"
                          : "7"
                      }
                      cols={windowWidth < 576 ? "50" : "70"}
                      style={{ display: "block" }}
                      type="textarea"
                    />
                  </div>
                ...
                {quesData[fmIndex].question_type === "BoolField" ||
                quesData[fmIndex].question_type === "ChoiceField" ? (
                  <div className="radio_div">
                    <form>
                      <div className="col-12 noMargin noPadding">
                        <div class="form-inline">
                          {quesData[fmIndex].options
                            .split(",")
                            .map((option, index) => (
                              <>
                                <div class="form-group noMargin radio_form">
                                  ...
                                  />
                                  <label
                                    for={"contactChoice" + index}
                                    className="radio_label text-left"
                                  >
                                    {option}
                                  </label>
                                </div>
                                {index ===
                                quesData[fmIndex].options.split(",").length -
                                  1 ? (
                                  <></>
                                ) : (
                                  <div class="form-group noMargin radio_form">
                    ...
                    <div className="row noPadding noMargin">
                      <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 noPadding noMargin">
                        ...
                        <div className="btm_head text-center ">
                          <span className="current_file_name">
                            {currFile && currFile.name}
                          </span>
                          {/* <span className="current_file_name">heyyy</span> */}
                        </div>
                      </div>
                      <div
                        className="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8 noPadding noMargin"
              ...
              <div className="popup_tail row noMargin noPadding">
                ...
                <div className="col-6 text-right alignSelfCenter noPadding">
                  <div className="popup_pagination_sec">
                    ...
                    />
                    <span className="qstn_count_status">
                      {fmIndex + 1} of {quesData && quesData.length}
                    </span>
                    <img
                      className="right_paginate"
                      src="/Images/rar.svg"
                      onClick={() => {
                        if (fmIndex + 1 < quesData.length) {
                          setCurrFile("");
