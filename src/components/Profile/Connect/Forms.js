...
export default function Forms(props) {
  ...
  const onAssignFormClick = (e) => {
    ...
    axios
      .get("/masters/approved-form-list", {
        headers: {
          Authorization: "Token" + " " + cookies.get("token"),
        },
        params: {
  ...
  const [createNewsForm, setCreateNewsFrom] = useState(false);

  const CreateNewsFn = () => {
    setCreateNewsFrom(true);
  };

  const CancelNewForm = () => {
    setCreateNewsFrom(false);
  };

  const [title, setTitle] = useState("");
  const [description, setDescription] = useState("");

  console.log("id from cookies", cookies.get("id"));
  ...
  function updateBasic() {
    ...
    axios
      ...
      .then((res) => {
        ...
        // history.push('/banner-image-views')
      })
      .catch((err) => {
          ...
          <div>
            <div className="row mt-5 ">
              <div className="col-xl-11 mx-auto  news-back">
                <p className="new-form-header  pl-5 pt-4">Create New Form</p>
                    ...
                    <div className="row">
                      <div className="col-xl-12">
                        ...
                        <input
                          ...
                          placeholder="Enter the form / survey title here..."
                        ></input>
                      </div>
                      <div className="col-xl-12 mt-3">
                        <p className="new-form-title mb-1">Form / Survey ID</p>
                        <p className="new-form-title mb-1"># 681-BYN</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-5 mx-auto ">
                    <p className="new-form-title mb-1">
                      Form / Survey short description
                    </p>
                    <textarea
                      rows="4"
                      className="new-form-input"
                      onChange={(e) => setDescription(e.target.value)}
                      placeholder="Enter the form / survey description here"
                      cols="45"
                    ></textarea>
                  </div>
                </div>
                ...
                <div className="row mt-5 p-2 mb-5">
                  ...
                  <div className="row">
                    <div className="col-xl-10  mt-3 mx-auto ">
                      <button
                        className="add-another-btn p-2 float-right"
                        onClick={addQuestion}
                      >
