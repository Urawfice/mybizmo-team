            ...
            <main className="my_forms_main">
                <div className='row noMargin noPadding top_menu_btn_sec_scss_class'>
                    <div className='col-12 top_menu_sec noPadding noMargin'>
                        ...
                        <Link to='/forms' >
                            <button className='topmenu_btn active_menu'><img className='topMenu_icon' src='Images/myActA.svg' /> Forms & Surveys </button>
                        </Link>
                    </div>
                </div>
                ...
                <div className="row noMargin noPadding btn_row button_margin_top" >
                    <button onClick={() => onAllClick()} className={activeBtn1 === 'Received' ? "common_btn blue_active" : "common_btn not_active_btn"} >All</button>
                    <button onClick={() => onUnreadClick()} className={activeBtn1 === 'Unread' ? "common_btn blue_active margin_left_btn" : "common_btn not_active_btn margin_left_btn"}>New </button>
                    <button onClick={() => onSentClick()} className={activeBtn1 === 'Sent' ? "common_btn blue_active margin_left_btn" : "common_btn not_active_btn margin_left_btn"}>Submitted</button>
                </div>
